    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Track and manage your assigned tasks.</p>
        </div>
        <button
          id="new-task-btn"
      ...
      {showForm && (
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="task-desc" className="text-sm font-medium">Description (optional)</label>
              <textarea
                id="task-desc"
                rows={2}
            ...
            <div className="space-y-3 p-4">
              {grouped[status].length === 0 ? (
                ...
                grouped[status].map((task) => (
                  <div key={task.id} className="rounded-lg border border-border bg-background p-4 transition hover:shadow-sm">
